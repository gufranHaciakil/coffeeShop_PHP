            ...
            <div class="row">
                ...
                <div class="col-md-6 pb-5">
                    <div class="contact-form">
                        <div id="success"></div>
                        <form action="https://formspree.io/f/mjvnpbql" name="sentMessage" id="contactForm" method="POST">
                            <div class="control-group">
                                <input type="text" name="name" class="form-control bg-transparent p-4" id="name"
                            ...
                            <div class="control-group">
                                <textarea class="form-control bg-transparent py-3 px-4" rows="5" id="message"
                                    placeholder="Message" name="message" required="required"
